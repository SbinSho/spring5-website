...
<div class="index-banner" style="min-height: 200px;">
	...
	<div class="index-mid-div animation-container">
		<div class="container py-5">
			...
			<div class="row">
		        <div class="col-md-4">
		            <img class="rounded-circle border border-dark" src="${ pageContext.request.contextPath }/resources/img/PDx2-600.jpg" width="140" height="140" alt="PD Series">
		            <h3>PD Series</h3>
		        ...
		        <div class="col-md-4">
		            <img class="rounded-circle border border-dark" src="${pageContext.request.contextPath}/resources/img/mRoy Series metering pumps.jpg" alt="Generic placeholder image" width="140" height="140" alt="mROY® Series">
		            <h3>mROY® Series</h3>
		         ...
		         <div class="col-md-4">
		            <img class="rounded-circle border border-dark" src="${pageContext.request.contextPath}/resources/img/img_AIR_PUMP.gif" alt="Generic placeholder image" width="140" height="140" alt="V Series Plunger Pumps">
