...
<!-- Milton Roy start-->
<div class="container pt-5 Milton-Roy-div animation-container">
	<h4 class="banner-content-big">Milton Roy Main Product</h4>
	<hr class="hr-line">
	<div class="row row-cols-1 row-cols-md-3">
	  <div class="col-sm mb-4">
	    <div class="card card-custom" onclick="window.open('https://www.miltonroy.com/en-kr/metering-pumps/centrac-series-metering-pumps')">
	      <img src="${ pageContext.request.contextPath }/resources/img/Milton_Roy_Products/CENTRAC Series Metering Pumps.jpg" class="card-img-top" alt="CENTRAC Series Metering Pumps.jpg">
	      <div class="card-body">
	  ...
	  <div class="col-sm mb-4">
	    <div class="card card-custom" onclick="window.open('https://www.miltonroy.com/en-kr/metering-pumps/maxroy-series-metering-pumps')">
	      <img src="${ pageContext.request.contextPath }/resources/img/Milton_Roy_Products/MaxRoy.jpg" class="card-img-top" alt="MaxRoy.jpg">
	      <div class="card-body">
	  ...
	  <div class="col-sm mb-4">
	    <div class="card card-custom" onclick="window.open('https://www.miltonroy.com/en-kr/metering-pumps/milroyal-series-metering-pumps')">
	      <img src="${ pageContext.request.contextPath }/resources/img/Milton_Roy_Products/Milroyal-D-Triplex low flow special with leak detection.jpg" class="card-img-top" alt="Milroyal-D-Triplex.jpg">
	      <div class="card-body">
	  ...
	  <div class="col-sm mb-4">
	    <div class="card card-custom" onclick="window.open('https://www.miltonroy.com/en-us/metering-pumps/proteus-metering-pumps')">
	      <img src="${ pageContext.request.contextPath }/resources/img/Milton_Roy_Products/Proteus Series Metering Pumps.jpg" class="card-img-top" alt="Proteus Series Metering Pumps.jpg">
	      <div class="card-body">
...
<!-- LMI start -->
<div class="container pt-5 LMI-div animation-container" style="display: none;">
	<h4 class="banner-content-big">LMI Roy Main Product</h4>
	<hr class="hr-line">
	<div class="row row-cols-1 row-cols-md-3">
	  <div class="col-sm mb-4">
	    <div class="card card-custom" onclick="window.open('https://www.lmipumps.com/en-kr/chemical-metering-pumps/excel-xr-metering-pumps')">
	      <img src="${ pageContext.request.contextPath }/resources/img/LMI_products/Group600x600.jpg" class="card-img-top" alt="Group600x600.jpg">
	      <div class="card-body">
	  ...
	  <div class="col-sm mb-4">
	    <div class="card card-custom" onclick="window.open('https://www.lmipumps.com/en-kr/chemical-metering-pumps/explosion-proof-metering-pumps')">
	      <img src="${ pageContext.request.contextPath }/resources/img/LMI_products/E-pump-520x520.jpg" class="card-img-top" alt="E-pump-520x520.jpg">
	      <div class="card-body">
	  ...
	  <div class="col-sm mb-4">
	    <div class="card card-custom" onclick="window.open('https://www.lmipumps.com/en-kr/chemical-metering-pumps/pd-series-chemical-metering-pump')">
	      <img src="${ pageContext.request.contextPath }/resources/img/LMI_products/PDx2-600.jpg" class="card-img-top" alt="PDx2-600.jpg">
	      <div class="card-body">
	  ...
	  <div class="col-sm mb-4">
	    <div class="card card-custom" onclick="window.open('https://www.lmipumps.com/en-kr/chemical-metering-pumps/series-b-chemical-metering-pumps')">
	      <img src="${ pageContext.request.contextPath }/resources/img/LMI_products/Series-B_600x600.jpg" class="card-img-top" alt="Series-B_600x600.jpg">
	      <div class="card-body">
	  ...
	  <div class="col-sm mb-4">
	    <div class="card card-custom" onclick="window.open('https://www.lmipumps.com/en-kr/chemical-metering-pumps/series-c-chemical-metering-pumps')">
	      <img src="${ pageContext.request.contextPath }/resources/img/LMI_products/Series-C600.jpg" class="card-img-top" alt="Series-C600.jpg">
	      <div class="card-body">
...
<!-- LMI end -->
<!-- WILL start -->
<div class="container pt-5 will-div animation-container" style="display: none;">
	<h4 class="banner-content-big">WILLIAMS Main Product</h4>
	<hr class="hr-line">
	<div class="row row-cols-1 row-cols-md-4">
	  <div class="col-sm mb-4">
	    <div class="card card-custom" onclick="window.open('https://www.williamspumps.com/products/pumps/v-series-plunger-pumps/')">
	      <img src="${ pageContext.request.contextPath }/resources/img/WILLIAMS_Products/menu_sub02_03_02_01.gif" class="card-img-top img-williams" alt="menu_sub02_03_02_01.gif">
	      <div class="card-body">
	  ...
	  <div class="col-sm mb-4">
	    ...
	    <img src="${ pageContext.request.contextPath }/resources/img/WILLIAMS_Products/W-Series-CRP2250W800-214x300.jpg" class="card-img-top img-williams" alt="W-Series-CRP2250W800-214x300.jpg">
	      <div class="card-body">
	  ...
	  <div class="col-sm mb-4">
	    <div class="card card-custom" onclick="window.open('https://www.williamspumps.com/products/pumps/wilroy-series-hydraulic-diaphragm-pump/')">
	      <img src="${ pageContext.request.contextPath }/resources/img/WILLIAMS_Products/WilRoyA-xylanBolts-300x428.jpg" class="card-img-top img-williams" alt="WilRoyA-xylanBolts-300x428.jpg">
	      <div class="card-body">
	  ...
	  <div class="col-sm mb-4">
	    <div class="card card-custom" onclick="window.open('https://www.williamspumps.com/products/pumps/cld-low-pressure-diaphragm-pump/')">
	      <img src="${ pageContext.request.contextPath }/resources/img/WILLIAMS_Products/CLD_316-Series-224x300.jpg" class="card-img-top img-williams" alt="CLD_316-Series-224x300.jpg">
	      <div class="card-body">
...
function Product_List(title) {
	var title_list = new Array("Milton-Roy-div","LMI-div","will-div");
	for(var i=0; i<3; i++){
		
		if(title_list[i] == title ){
			$("." + title_list[i]).css("display", "block");
// 			$("." + title_list[i]).fadeTo(1,1); jquery 애니메이션 효과줄려면 css에서 transition로 시간 주면 천천히 효과적용 가능
		}
		else{
			$("." + title_list[i]).css("display", "none");
		}
	}
